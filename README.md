...
<h1>debup</h1>
<p><strong>debup package manager: The missing bridge between GitHub and Debian/Ubuntu-based distributions,Raspberry Pi, Docker, WSL & Android Linux Terminal (AVF).</strong></p>
